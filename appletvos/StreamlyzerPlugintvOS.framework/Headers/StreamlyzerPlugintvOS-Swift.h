...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StreamlyzerPlugintvOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
- (void)onPlayerErrorMessageWithGroup:(NSString * _Nonnull)group errorGroup:(NSString * _Nonnull)errorGroup errorMessage:(NSString * _Nonnull)errorMessage;
...
- (void)onPlayNext;
/// Call this method when the language of audio track has changed.
/// @param audioLanguage Language of the content audio. For example “en”, https://tools.ietf.org/html/rfc5646.
- (void)onChangeAudioLanguageWithAudioLanguage:(NSString * _Nonnull)audioLanguage;
/// Call this method when the language of subtitle has changed.
/// @param subtitleLanuage Language of the content subtitle. For example “en”, https://tools.ietf.org/html/rfc5646. “none” if none.
- (void)onChangeSubtitleLanguageWithSubtitleLanuage:(NSString * _Nonnull)subtitleLanuage;
/// Get ticket id from plugin for sharing ticketid number with Chromecast
- (NSString * _Nonnull)getTicketId SWIFT_WARN_UNUSED_RESULT;
/// Call this method when the session of Chromecast is being connecting. It is used for measuring connecting time.
- (void)onChromecastConnecting;
/// Call this method when the session of Chromecast is being connected.
- (void)onChromecastConnected;
/// Call this method when the session of Chromecast is being disconnected
- (void)onChromecastDisconnected;
/// Call this method when Chromecast errors are occured
/// @param error error message
- (void)onChromecastErrorWithErrorMessage:(NSString * _Nonnull)errorMessage;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) StreamlyzerPlugin * _Nonnull sharedInstance;)
+ (StreamlyzerPlugin * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
